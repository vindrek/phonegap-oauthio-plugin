...
"use strict";
var Location, Url, cache, config, lstorage;
...
module.exports = function(Materia) {
  var $, Url, cache, client_states, config, document, location_operations, oauth, oauthio, providers_api, window;
  Url = Materia.getUrl();
  ...
  oauth = {
    ...
    popup: function(provider, opts, callback) {
      var defer, frm, getMessage, gotmessage, res, url, wnd, wndTimeout;
      gotmessage = false;
